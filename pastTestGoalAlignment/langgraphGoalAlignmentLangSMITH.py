...
def dummy_tool():
    ...
    return random.choice(["Interesting idea!", "Needs more detail!", "Could be improved."])
...
# inputs = [
#     # 1st round: Provide an initial user message via the inputs.
#     {
#         "messages": [
#             {"role": "user", "content": "I want to lose weight."}
#         ]
#     },
#     # 2nd round: Simulate human input via a resume command.
#     Command(resume="I want to create a personal fitness goal."),
#     # 3rd round: Simulate another human input.
#     Command(resume="Ok, let's validate that goal now."),
#     # 4th round: Simulate final user input.
#     Command(resume="Yes, I'm satisfied with the final goal. Thank you."),
# ]

# Extended, more realistic conversation simulation.
inputs = [
    ...
    Command(resume="Specifically, I want to reduce my calorie intake and incorporate cardio and strength training."),
